...
import kg.test.app_project2.databinding.ActivityGitaraRepAddBinding

class GitaraRepAddActivity : AppCompatActivity() {
    private lateinit var binding: ActivityGitaraRepAddBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding= ActivityGitaraRepAddBinding.inflate(layoutInflater)
