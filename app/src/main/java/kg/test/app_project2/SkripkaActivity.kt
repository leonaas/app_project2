...
import kg.test.app_project2.databinding.ActivitySkripkaBinding

class SkripkaActivity : AppCompatActivity() {
    private lateinit var binding: ActivitySkripkaBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding= ActivitySkripkaBinding.inflate(layoutInflater)
