...
class MessageAlinaRepActivity : AppCompatActivity() {
    private lateinit var binding: ActivityMessageAlinaBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding= ActivityMessageAlinaBinding.inflate(layoutInflater)
