...
import kg.test.app_project2.databinding.ActivityFrenchRepAddBinding

class FrenchRepAddActivity : AppCompatActivity() {
    private lateinit var binding: ActivityFrenchRepAddBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding= ActivityFrenchRepAddBinding.inflate(layoutInflater)
