...
import kg.test.app_project2.databinding.ActivityPianoRepAddBinding

class PianoRepAddActivity : AppCompatActivity() {
    private lateinit var binding: ActivityPianoRepAddBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding= ActivityPianoRepAddBinding.inflate(layoutInflater)
