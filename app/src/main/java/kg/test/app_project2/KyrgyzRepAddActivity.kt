...
import kg.test.app_project2.databinding.ActivityKyrgyzRepAddBinding

class KyrgyzRepAddActivity : AppCompatActivity() {
    private lateinit var binding: ActivityKyrgyzRepAddBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding= ActivityKyrgyzRepAddBinding.inflate(layoutInflater)
