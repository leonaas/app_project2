...
import kg.test.app_project2.databinding.ActivityRussianRepAddBinding

class RussianRepAddActivity : AppCompatActivity() {
    private lateinit var binding: ActivityRussianRepAddBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding= ActivityRussianRepAddBinding.inflate(layoutInflater)
