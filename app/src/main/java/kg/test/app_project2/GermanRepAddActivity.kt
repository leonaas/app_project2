...
import kg.test.app_project2.databinding.ActivityGermanAddRepBinding

class GermanRepAddActivity : AppCompatActivity() {
    private lateinit var binding: ActivityGermanAddRepBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding= ActivityGermanAddRepBinding.inflate(layoutInflater)
