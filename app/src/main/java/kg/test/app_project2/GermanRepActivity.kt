...
import kg.test.app_project2.databinding.ActivityGermanRepBinding

class GermanRepActivity : AppCompatActivity() {
    private lateinit var binding: ActivityGermanRepBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding= ActivityGermanRepBinding.inflate(layoutInflater)
        ...
        binding.add.setOnClickListener {
            startActivity(Intent(this, GermanRepAddActivity::class.java))
            finish()
        }
    }
}