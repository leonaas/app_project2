...
import kg.test.app_project2.databinding.ActivitySkripkaRepBinding

class SkripkaRepActivity : AppCompatActivity() {
    private lateinit var binding: ActivitySkripkaRepBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding= ActivitySkripkaRepBinding.inflate(layoutInflater)
        ...
        binding.add.setOnClickListener {
            startActivity(Intent(this, SkripkaRepAddActivity::class.java))
            finish()
        }
    }
}