...
import kg.test.app_project2.databinding.ActivityMessageUserBinding

class MessageUserRepActivity : AppCompatActivity() {
    private lateinit var binding: ActivityMessageUserBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding= ActivityMessageUserBinding.inflate(layoutInflater)
