...
import kg.test.app_project2.databinding.ActivitySkripkaRepAddBinding

class SkripkaRepAddActivity : AppCompatActivity() {
    private lateinit var binding: ActivitySkripkaRepAddBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding= ActivitySkripkaRepAddBinding.inflate(layoutInflater)
