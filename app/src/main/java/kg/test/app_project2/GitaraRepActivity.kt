...
import kg.test.app_project2.databinding.ActivityGitaraRepBinding

class GitaraRepActivity : AppCompatActivity() {
    private lateinit var binding: ActivityGitaraRepBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding= ActivityGitaraRepBinding.inflate(layoutInflater)
        ...
        binding.add.setOnClickListener {
            startActivity(Intent(this, GitaraRepAddActivity::class.java))
            finish()
        }
    }
}