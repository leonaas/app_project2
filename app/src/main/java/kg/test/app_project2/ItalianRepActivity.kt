...
import kg.test.app_project2.databinding.ActivityItalianRepBinding

class ItalianRepActivity : AppCompatActivity() {
    private lateinit var binding: ActivityItalianRepBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding= ActivityItalianRepBinding.inflate(layoutInflater)
        ...
        binding.add.setOnClickListener {
            startActivity(Intent(this, ItalianRepAddActivity::class.java))
            finish()
        }
    }
}