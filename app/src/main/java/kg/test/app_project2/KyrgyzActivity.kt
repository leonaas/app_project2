...
import kg.test.app_project2.databinding.ActivityItalianBinding
import kg.test.app_project2.databinding.ActivityKyrgyzBinding

class KyrgyzActivity : AppCompatActivity() {
    private lateinit var binding: ActivityKyrgyzBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding= ActivityKyrgyzBinding.inflate(layoutInflater)
