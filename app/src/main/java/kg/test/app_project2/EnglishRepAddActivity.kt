...
class EnglishRepAddActivity : AppCompatActivity() {
    private lateinit var binding: ActivityEnglishRepAddBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding= ActivityEnglishRepAddBinding.inflate(layoutInflater)
